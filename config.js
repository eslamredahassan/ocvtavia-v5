module.exports = {
	...
	adminId: "123788535324082178", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "ODc3NTQ2MDQxNjMxNzM1ODU4.G3gmAP.iuHTAJt-wBIj01OhLMUVx2qJxqmxt2hRouZByY", //- Bot's Token
	clientId: process.env.clientId || "877546041631735858", //- ID of the bot
	clientSecret: process.env.clientSecret || "4_TRBrSMwYcfsKtrC4E67aT-Rcv8uoUA", //- Client Secret of the bot
	...
	nodes: [
		{
			...
			host: "nonssl.freelavalink.ga", //- The host name or IP of the lavalink server.
